            ...
            <div className="grid gap-6 md:grid-cols-3 xl:gap-x-12">
              ...
              <div className="mb-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  <div className="flex">
                    ...
                    >
                      <img src="/PoniX.png" className="w-full" />
                      <a href="#!">
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">PoniX</h5>
                    <h6 className="mb-4 font-medium">Isidora Vasquez</h6>
                ...
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  <div className="flex">
                    <div
                      ...
                      data-te-ripple-color="light"
                    >
                      <img src="/Adenina.png" className="w-full" />
                      <a href="#!">
                        <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsl(0,0%,98.4%,0.15)] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"></div>
                      </a>
                    </div>
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">Adenina</h5>
                    <h6 className="mb-4 font-medium">Karina Fumero</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>Uruguay - 26 años</li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  <div className="flex">
                    <div
                      ...
                      data-te-ripple-color="light"
                    >
                      <img src="/nicky.png" className="w-full" />
                      <a href="#!">
                        <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsl(0,0%,98.4%,0.15)] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"></div>
                      </a>
                    </div>
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">nicky</h5>
                    <h6 className="mb-4 font-medium">Nicole Ferreyra</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>Argentina - 21 años</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">babZ</h5>
                    <h6 className="mb-4 font-medium">Bárbara Moniz</h6>
                    <ul className="mb-6 flex justify-center">
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">none</h5>
                    <h6 className="mb-4 font-medium">Kauan Ferreira</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>Brasil</li>
                    </ul>
                  </div>
