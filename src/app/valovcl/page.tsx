              ...
              <div className="mb-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">David Olivares</h6>
              ...
              <div className="mb-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Gabriel González</h6>
                    <ul className="mb-6 flex justify-center">
              ...
              <div className="mb-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Facundo Chavez</h6>
                    <ul className="mb-6 flex justify-center">
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Giulliano Massone</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>Chile - 23 años</li>
                    </ul>
                  </div>
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Gonzalo Funes</h6>
                    <ul className="mb-6 flex justify-center">
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Gonzalo Manzano</h6>
                    <ul className="mb-6 flex justify-center">
