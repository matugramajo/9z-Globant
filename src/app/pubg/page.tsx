            ...
            <div className="grid gap-6 md:grid-cols-3 xl:gap-x-12">
              ...
              <div className="mb-6 lg:mb-0">
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  <div className="flex">
                    ...
                    >
                      <img src="/Choco.png" className="w-full" />
                      <a href="#!">
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">Choco</h5>
                    <h6 className="mb-4 font-medium">Jorge García</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>Mexico - 19 años</li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  <div className="flex">
                    <div
                      ...
                      data-te-ripple-color="light"
                    >
                      <img src="/Elite.png" className="w-full" />
                      <a href="#!">
                        <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsl(0,0%,98.4%,0.15)] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"></div>
                      </a>
                    </div>
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">Elite</h5>
                    <h6 className="mb-4 font-medium">Cristóbal Díaz</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>Chile - 20 años</li>
                    </ul>
                  </div>
                ...
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  <div className="flex">
                    <div
                      ...
                      data-te-ripple-color="light"
                    >
                      <img src="/S1mple.png" className="w-full" />
                      <a href="#!">
                        <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsl(0,0%,98.4%,0.15)] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"></div>
                      </a>
                    </div>
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">S1mple</h5>
                    <h6 className="mb-4 font-medium">Cristian Yañez</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>Chile - 25 años</li>
                    </ul>
                  </div>
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">Konor</h5>
                    <h6 className="mb-4 font-medium">Konor</h6>
                    <ul className="mb-6 flex justify-center">
                      <li>.</li>
                    </ul>
                  </div>
