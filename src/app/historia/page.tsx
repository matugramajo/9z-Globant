          ...
          <li key={link.name} className="text-lg">
            <a
              ...
              className={`hover:text-gray-400 font-sans duration-500 ${
                link.name == "Historia" ? "text-purple-600" : "text-white"
              }`}
            >
              {link.name}
            </a>
    ...
    <>
      <header className="bg-[#000000] text-white font-mono text-xl tracking-wide sticky top-0 z-10">
        ...
        >
          ...
          <div className="flex group items-center justify-center space-x-8 basis-1/3">
            <Link href="/historia" className="text-violet-600 scale-110">
              HISTORIA
            </Link>
          </div>
        </nav>
      ...
      <main className="bg-[#000000] text-white">
        <section className="bg-[#000000]">
          <div className="gap-16 items-center pb-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-9 lg:px-6">
