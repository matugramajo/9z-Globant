              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Matias Ibañez</h6>
                    <h6 className="mb-4 font-medium">Rifler</h6>
                    <ul className="mb-6 flex justify-center">
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Antonio Martinez</h6>
                    <h6 className="mb-4 font-medium">AWPer</h6>
                    <ul className="mb-6 flex justify-center">
              ...
              <div className="mb-6 md:pt-6 lg:mb-0">
                <div className="relative block rounded-lg  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <h6 className="mb-4 font-medium">Gustavo Motta</h6>
                    <h6 className="mb-4 font-medium">Coach</h6>
                    <ul className="mb-6 flex justify-center">
